...
//IO操作函数	 
#define IIC_SCL_H    HAL_GPIO_WritePin(GPIOB, GPIO_PIN_10, GPIO_PIN_SET)        //SCL
#define IIC_SCL_L    HAL_GPIO_WritePin(GPIOB, GPIO_PIN_10, GPIO_PIN_RESET)     //SCL

#define IIC_SDA_H    HAL_GPIO_WritePin(GPIOB, GPIO_PIN_11, GPIO_PIN_SET)     //SDA	 
#define IIC_SDA_L 	 HAL_GPIO_WritePin(GPIOB, GPIO_PIN_11, GPIO_PIN_RESET)  //SCL
#define SSDA         HAL_GPIO_ReadPin(GPIOB,GPIO_PIN_11)
typedef struct
{
